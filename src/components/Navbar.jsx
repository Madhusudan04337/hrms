    ...
    return (
        <div className="side-navbar d-flex flex-column flex-shrink-0 p-3">
            ...
            <ul className='nav flex-column mb-auto'>
                ...
                <li className='w-100 mb-1'><button onClick={() => setActivePage('feed')} className={`nav-link text-white w-100 text-start ${activePage === 'feed'?'active':''}`}><FaBookOpen className='me-2' />Feed</button></li>
                <li className='w-100 mb-1'><button onClick={() => setActivePage('recogination')} className={`nav-link text-white w-100 text-start ${activePage === 'recogination'?'active':''}`}><FaChartBar className='me-2' />Recogination</button></li>
